...
<!--form id="photo_display_form" action="photoframe" method="post"-->   
...
<TR align=center>
	...
	<form id="first_post_form" action="photoframe" method="post" target="show_photo_frame">	
  ...
  <td align=center width=20 height=24>			
	<form id="fast_back_post_form" action="photoframe" method="post" target="show_photo_frame">	
  <input type="image" src="View/images/button_fast_back.gif" border=0 alt="Ten steps backward..." title="Ten steps backward..." 
  ...
  <td align=center width=20 height=24>			
	<form id="prev_post_form" action="photoframe" method="post" target="show_photo_frame">	
  ...
  <td align=center width=20 height=24>		
	<form id="next_post_form" action="photoframe" method="post" target="show_photo_frame">	
  ...
  <td align=center width=20 height=24>			
	<form id="fast_next_post_form" action="photoframe" method="post" target="show_photo_frame">	
  ...
  <td align=center width=20 height=24>			
	<form id="last_post_form" action="photoframe" method="post" target="show_photo_frame">	
...
%>
	...
	for(int j = 0; j < 5; j++)
	{
		int id= currentPagStartId+(i*5)+j;
		if( id< imgIdAry.length)
		{
	   long imgId = imgIdAry[id];
	%>
