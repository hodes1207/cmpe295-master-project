...
<form id="caseSearchForm" action="../casesearch" method="post" enctype="multipart/form-data" target="case_search_photo_frame" >
			...
			<!-- 	Domain: <select class="required" id="domain" name="domain">
                ...
                Input Image Listing Number: <input type="text" name="listNum"> <br>
    ...
    <div class="span8">
<iframe name="case_search_photo_frame" src="case_search_display_photo.jsp" id="case_search_photo_frame" width="900" height="500">
</iframe>  
      <!--Body content-->
    </div>
  </div>
