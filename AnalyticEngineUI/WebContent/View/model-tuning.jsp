...
<form id="tree_form" action="../modeltuning" method="post" target="model_config_frame">   
...
pinetree.treetop.draw(); //REQUIRED LINE: Initalize tree
      ...
      <!--Sidebar content-->
        ...
        if(request.getParameter("domainId")!=null)
			session.setAttribute("domainId", -1); 
        
        %>
<iframe name="model_config_frame" src="model_config.jsp" id="model_config_frame" width="800" height="400">
</iframe> 
...
pinetree.treetop.subscribe("dblClickEvent", function(oArgs){
	...
	document.getElementById("domain_name").setAttribute("value", oArgs.node.label);
